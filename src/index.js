...
if (typeof context.BlockBank === 'undefined') {
  context.BlockBank = BlockBank
}
...
ProviderEngine.prototype.send = function (payload) {
  ...
  switch (payload.method) {
    ...
    default:
      var message = `The BlockBank Web3 object does not support synchronous methods like ${payload.method} without a callback parameter.`
