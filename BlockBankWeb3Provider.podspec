...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/BlockBank/BlockBankWeb3Provider'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'hewigovens' => 'hewigovens@gmail.com', 'Viktor Radchenko' => 'vikmeup' }
  s.source           = { :git => 'https://github.com/BlockBank/BlockBankWeb3Provider.git', :tag => s.version.to_s }
  s.social_media_url = 'https://twitter.com/BlockBank'
  s.ios.deployment_target = '8.0'

  s.resource_bundles = {
    'BlockBankWeb3Provider' => ['dist/BlockBank-min.js']
  }
end
